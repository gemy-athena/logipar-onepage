export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', property: 'og:image', content: '~/assets/logos/logipar_couleur_hd.png' },
      ...
      { hid: 'twitter:image', name: 'twitter:image', content: '~/assets/logos/logipar_couleur_hd.png' },
